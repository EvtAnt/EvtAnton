...
namespace LabWork__1_ClassLib
{
    ...
    public class PersonList
    {
        ...
        // УБРАТЬ И ЧЕРЕЗ ИНДЕКСАТОР
        ///// <summary>
        ///// Метод, возвращащий персону по индексу
        ///// </summary>
        ///// <param name="indexPersonTransfer">
        ///// Номер возвращаемого элемента
        ///// </param>
        ///// <returns></returns>
        //public Person PersonTransferToIndex(int indexPersonTransfer)
        //{
        //    return _personList[indexPersonTransfer - 1];
        //}
    }
}
